...
template <typename T>
int BinaryTree<T>::sumDistances(const Node* subroot, int curDist) const {
  if (subroot == NULL) return 0;
  return curDist + sumDistances(subroot->left, curDist+1) + sumDistances(subroot->right, curDist+1);
}
...
//   // return height(subroot) + sumDistances(subroot->left) + sumDistances(subroot->right);


//   // if (subroot == NULL) return 0;
//   // else if (subroot->left == NULL && subroot->right == NULL) {
//   //   return 2*height(subroot) -1;
//   // } else {
...
//   if (subroot == NULL) return 0;
//   else if (subroot->left == NULL && subroot->right == NULL) {
//     return height(subroot);
//   } else {
//     return 2*sumDistances(subroot->left) + 2*sumDistances(subroot->right) ;
//   }
